...
def main():
    ...
    github_user = "yaser01"
    github_repo = "mkv-muxing-batch-gui"
...
def render_choco_files(latest_version, win32_url, win32_hashsum):
    ...
    file = open('mkv-muxing-batch-gui.nuspec', 'w')
...
def get_download_url_from_html(keyphrase, github_html_data_lines, version):
    ...
    for line in github_html_data_lines:
        ...
        if "download" not in line:
            continue
        # https://github.com/yaser01/mkv-muxing-batch-gui/releases/download/1.0.5/MKV.Muxing.Batch.GUI.Portable.x64.zip
